...
test('initializes with sprout, compiles with spike', t => {
  ...
  const locals = { name: 'doge', description: 'wow', github_username: 'amaze', production: false, sugar: false }
...
test('compiles with sugar option', t => {
  const tplName = 'spike-tpl-base-test'
  const locals = { name: 'doge', description: 'wow', github_username: 'amaze', production: false, sugar: true }
  const sprout = new Sprout(tmpdir())
...
test('compiles with production setting', t => {
  ...
  const locals = { name: 'doge', description: 'wow', github_username: 'amaze', production: true, sugar: false }
  const sprout = new Sprout(tmpdir())
